...
public class EmployeeRest {
	...
	@GET
	//executes query (/? name="name"&age="age")
	public Response employeeById(@QueryParam("name") final String name, @QueryParam("age") final Integer age) {
	...
	@GET
	@Path("/matrix")//(/matrix;name="name";age="age")
	public Response employeeMatrixQuery(@MatrixParam("name") final String name, @MatrixParam("age") final Integer age) {
